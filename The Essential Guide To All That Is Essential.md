...
**Arrays**
  ...
  - [x] [Max sum in the configuration](http://practice.geeksforgeeks.org/problems/max-sum-in-the-configuration/1/?ref=self) - [my soln](http://practice.geeksforgeeks.org/viewSol.php?subId=4220568&pid=700276&user=RC0709)
