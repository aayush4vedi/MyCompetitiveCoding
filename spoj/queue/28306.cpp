...
int main(){
  ...
  while(t--){
    ...
    if(s== "toFront"){ cin>>n;
                      q.push_front(n);}
    else if(s=="back"){ if(!q.empty()){cout<<q.back();NL;q.pop_back();}
                   else{cout<<"No job for Ada?\n";}
                 }
    else if(s=="front"){ if(!q.empty()){cout<<q.front();NL;q.pop_front();}
                    else{cout<<"No job for Ada?\n";}
                  }
    else if(s=="reverse"){if(!q.empty()){reverse(q);}
                    else{cout<<"No job for Ada?\n";}
                  }

    else if(s== "push_back"){ cin>>n;q.push_back(n);}
